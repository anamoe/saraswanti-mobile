...
import 'package:saraswantiland/screen/galery/GaleryImage.dart';
...
class SarasGallery extends StatefulWidget {
  ...
  @override
  _SarasGalleryState createState() =>
      _SarasGalleryState();
}

class _SarasGalleryState
    extends State<SarasGallery> {
  int _currentIndex;
